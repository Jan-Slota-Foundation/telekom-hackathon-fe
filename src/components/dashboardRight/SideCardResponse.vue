...
<template>
  <div class="flex gap-3 items-start">
    <div
      class="rounded-lg border-2 p-4 flex aspect-square text-primary-600 justify-center items-center border-primary-600 fill-primary-600"
    >
      <svg
