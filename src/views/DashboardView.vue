...
import { rightSideStore } from '@/store/rightSideStore'
</script>
<template>
  <div class="p-3">
    <div class="mb-8 flex justify-between items-center">
      <div class="">
        <h1 class="text-primary-600 mb-2 text-5xl font-semibold">
          Penetration Tester
        </h1>
        <a target="_blank" href="https://hiimmilan.dev/hacktelecom/"
          >Static dependency analysis</a
        >
      </div>
      <AppButton @click="displayCrawlerAnalysis">
    ...
    <div class="flex gap-4">
      ...
      <section class="min-w-[40rem]">
        <DetailistWindow v-if="!vulnerabilityStore?.selectedExploit?.name" />
        <AdditionalDetailsWindow
          v-if="vulnerabilityStore?.selectedExploit?.name"
        />
      </section>
...
import AdditionalDetailsWindow from '../components/dashboardDetailist/AdditionalDetailsWindow.vue'
export default {
  name: 'DashboardView',
  ...
  methods: {
    ...
    displayCrawlerAnalysis() {
      rightSideStore.type = 'crawler'
    }
  }
}
</script>
